...
# -*- coding: utf-8 -*-
#
# pastream documentation build configuration file, created by
...
project = 'pastream'
copyright = '2017, Thomas J. Garcia'
...
man_pages = [
    (master_doc, 'pastream', 'pastream Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pastream', 'pastream Documentation',
     author, 'pastream', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    'soundfile': ('http://pysoundfile.readthedocs.io/en/latest/', None),
    'sounddevice': ('http://python-sounddevice.readthedocs.io/en/latest/', None),
    'cffi': ('http://cffi.readthedocs.io/en/latest/', None),
